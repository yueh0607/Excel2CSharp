...
namespace FFramework.MVVM.UnityEditor
{
    ...
    {
        public static string interfaceText = $"{typeof(IModel).FullName}";
...
#GENERATEDATA#
        ...
        private System.Collections.Generic.Dictionary<#PRIMARYKEYTYPE#,#ITEMNAME#> dataMap = null;
        ...
        {{
            ...
            {{
                if(dataMap==null)
                {{
                    dataMap = new System.Collections.Generic.Dictionary<#PRIMARYKEYTYPE#,#ITEMNAME#>();
