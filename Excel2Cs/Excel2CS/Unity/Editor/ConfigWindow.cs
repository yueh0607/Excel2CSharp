...
namespace AirEditor
{
    ...
    [FilePath("ConfigWindowCache.asset",FilePathAttribute.LocationType.AssetsFolder)]
    public class ConfigCache : ScriptableObjectSingleton<ConfigCache>
    {
        public string generatePath = "Assets/Scripts/ConstModels";
        public string originPath = "Assets/CSV";
    ...
    public class ConfigWindow : EditorWindow
    {
        ...
        {
            EditorUtility.SetDirty(ConfigCache.Instance);
